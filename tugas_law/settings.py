"""
Django settings for tugas_law project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-&ctwydhcdhmd_bf&#avm=ip8t!6qr4y)#1asof7&!plt0^6rm^')
...
ALLOWED_HOSTS = [f'{HEROKU_APP_NAME}.herokuapp.com', 'infralabs.cs.ui.ac.id']
...
WSGI_APPLICATION = 'tugas_law.wsgi.application'
